resource "aws_iam_role" "demo_iam_role_code_deploy" {
  ...
  assume_role_policy = "${data.aws_iam_policy_document.demo_iam_role_policy_codedeploy_assumerole.json}"
  path               = "/service-role/"
...
resource "aws_iam_policy" "demo_iam_policy_codedeploy" {
  ...
  policy      = "${data.aws_iam_policy_document.demo_iam_policy_document_codedeploy.json}"
